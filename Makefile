export TARGET = iphone:clang:18.4:17.0
export SDK_PATH = $(THEOS)/sdks/iPhoneOS18.4.sdk/
...
export ADDITIONAL_CFLAGS = -I$(THEOS_PROJECT_DIR)/Tweaks/RemoteLog -I$(THEOS_PROJECT_DIR)/Tweaks -Wno-vla-extension -Wno-vla-cxx-extension
...
YOUTUBE_VERSION = 20.20.5
ifndef YOUTUBE_VERSION
YOUTUBE_VERSION = 20.14.2
endif
ifndef UYOU_VERSION
UYOU_VERSION = 3.0.4
endif
